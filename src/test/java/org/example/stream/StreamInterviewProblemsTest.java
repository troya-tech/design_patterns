...
class StreamInterviewProblemsTest {
    ...
    void testAdultNames() {
        ...
        List<String> result = StreamInterviewProblems.adultNames(people);
        assertEquals(List.of("Alice", "Charlie", "Diana"), result);
    }

    @Test
    void testAdultNames_EmptyList() {
        List<String> result = StreamInterviewProblems.adultNames(List.of());
    ...
    void testNormalize() {
        ...
        List<String> result = StreamInterviewProblems.normalize(input);
    ...
    void testNormalize_EmptyList() {
        List<String> result = StreamInterviewProblems.normalize(List.of());
        assertTrue(result.isEmpty());
    }
    ...
    void testCountPrefix() {
        ...
        long result = StreamInterviewProblems.countPrefix(words, "app");
    ...
    void testCountPrefix_EmptyPrefix() {
        ...
        long result = StreamInterviewProblems.countPrefix(words, "");
    ...
    void testSumSquares() {
        ...
        int result = StreamInterviewProblems.sumSquares(nums);
        assertEquals(55, result); // 1+4+9+16+25 = 55
    }

    @Test
    void testSumSquares_EmptyList() {
        int result = StreamInterviewProblems.sumSquares(List.of());
        assertEquals(0, result);
    }
    ...
    void testFirstEven() {
        ...
        Optional<Integer> result = StreamInterviewProblems.firstEven(nums);
    ...
    void testDistinctCitiesSorted() {
        ...
        List<String> result = StreamInterviewProblems.distinctCitiesSorted(people);
    ...
    void testJoinNames() {
        ...
        String result = StreamInterviewProblems.joinNames(people);
        assertEquals("Alice,Bob,Charlie", result);
    }

    @Test
    void testJoinNames_EmptyList() {
        String result = StreamInterviewProblems.joinNames(List.of());
        assertEquals("", result);
    }
    ...
    void testPartitionAdults() {
        ...
        Map<Boolean, List<Person>> result = StreamInterviewProblems.partitionAdults(people);
    ...
    void testTopN() {
        ...
        List<Integer> result = StreamInterviewProblems.topN(nums, 3);
        assertEquals(List.of(9, 8, 5), result);
    }

    @Test
    void testTopN_EmptyList() {
        List<Integer> result = StreamInterviewProblems.topN(List.of(), 3);
        assertTrue(result.isEmpty());
    }
    ...
    void testTopN_NLargerThanList() {
        ...
        List<Integer> result = StreamInterviewProblems.topN(nums, 10);
    ...
    void testAnyInvalidEmail() {
        ...
        boolean result = StreamInterviewProblems.anyInvalidEmail(emails);
        assertTrue(result);
    }
    ...
    void testGroupByCity() {
        ...
        Map<String, List<Person>> result = StreamInterviewProblems.groupByCity(people);
    ...
    void testCountByCity() {
        ...
        Map<String, Long> result = StreamInterviewProblems.countByCity(people);
    ...
    void testAvgAgeByCity() {
        ...
        Map<String, Double> result = StreamInterviewProblems.avgAgeByCity(people);
    ...
    void testNamesByCity() {
        ...
        Map<String, List<String>> result = StreamInterviewProblems.namesByCity(people);
    ...
    void testUniqueNamesByCity() {
        ...
        Map<String, Set<String>> result = StreamInterviewProblems.uniqueNamesByCity(people);
    ...
    void testFlattenDistinctSorted() {
        ...
        List<Integer> result = StreamInterviewProblems.flattenDistinctSorted(lists);
    ...
    void testTotalPaid() {
        ...
        double result = StreamInterviewProblems.totalPaid(orders);
    ...
    void testTopEarnerByDept() {
        ...
        Map<String, Optional<Employee>> result = StreamInterviewProblems.topEarnerByDept(emps);
    ...
    void testMaxSalaryByDept() {
        ...
        Map<String, Integer> result = StreamInterviewProblems.maxSalaryByDept(emps);
    ...
    void testSecondHighestDistinct() {
        ...
        OptionalInt result = StreamInterviewProblems.secondHighestDistinct(nums);
        assertTrue(result.isPresent());
    ...
    void testMostFrequentWord() {
        ...
        Optional<String> result = StreamInterviewProblems.mostFrequentWord(words);
        assertTrue(result.isPresent());
    ...
    void testProductNonZero() {
        ...
        int result = StreamInterviewProblems.productNonZero(nums);
    ...
    void testProductNonZero_EmptyList() {
        int result = StreamInterviewProblems.productNonZero(List.of());
        assertEquals(1, result);
    }
    ...
    void testTotalSpentByCustomer() {
        ...
        Map<String, Double> result = StreamInterviewProblems.totalSpentByCustomer(orders);
    ...
    void testOrderTotalFromItems() {
        ...
        Map<String, Double> result = StreamInterviewProblems.orderTotalFromItems(items);
    ...
    void testTotalQtyByCustomerPaid() {
        ...
        Map<String, Integer> result = StreamInterviewProblems.totalQtyByCustomerPaid(orders, items);
    ...
    void testTop3SkusByRevenue() {
        ...
        List<String> result = StreamInterviewProblems.top3SkusByRevenue(items);
        assertEquals(3, result.size());
    ...
    void testDistinctByNameKeepFirst() {
        ...
        List<Person> result = StreamInterviewProblems.distinctByNameKeepFirst(people);
        assertEquals(3, result.size());
    ...
    void testGroupCitySorted() {
        ...
        Map<String, List<Person>> result = StreamInterviewProblems.groupCitySorted(people);
    ...
    void testWindowSums() {
        List<Integer> nums = List.of(1, 2, 3, 4, 5);
        List<Integer> result = StreamInterviewProblems.windowSums(nums, 3);
    ...
    void testWindowSums_WindowSize1() {
        List<Integer> nums = List.of(1, 2, 3);
        List<Integer> result = StreamInterviewProblems.windowSums(nums, 1);
    ...
    void testDuplicateEmails() {
        ...
        List<String> result = StreamInterviewProblems.duplicateEmails(emails);
        assertEquals(2, result.size());
    ...
    void testDuplicateEmails_EmptyList() {
        List<String> result = StreamInterviewProblems.duplicateEmails(List.of());
        assertTrue(result.isEmpty());
    }
}
